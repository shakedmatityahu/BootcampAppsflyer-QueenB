            ...
            <div className="navbar-left">
                ...
                {currentUser && (
                    <>
                        ...
                        {currentUser && currentUser.userType === "mentor" && (<Link to="/Messages" className="navbar-link">Messages</Link>)}
                    </>
                )}
            </div >
                    ...
                    currentUser ? (
                        ...
                        <>
                            <Link to="/Profile" className="navbar-link">
                                ...
                                <svg width="22px" height="28px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
