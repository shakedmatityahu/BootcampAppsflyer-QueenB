    ...
    <Modal show={showMentorDetails} onHide={handleCloseMentorDetails} animation={false} centered>
      ...
      <Modal.Footer>
        ...
        <a className="link-opacity-10-hover" href={`mailto:${mentor.email}`} target="_blank">
          ...
          <a className="link-opacity-10-hover" href={`http://wa.me/+972${mentor.phone_number}`} target="_blank">
          ...
          <a className="link-opacity-10-hover" href={mentor.linkedin} target="_blank">
